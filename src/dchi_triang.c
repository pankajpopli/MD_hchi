...
double d_hchi_triang(int moved_particle,double *jstdelChi)
{	
	int nbr_triang =  6;
	//-------------------------------------Define variables---------------------------------------------------------//
	int i=0,j=0,k=0,xi=0,yi=0,N,sit=0,sit_dmy1=0;
	...
	for(j=0;j<nbr_triang+1;j++) //where particle 0 consists the moved_particle id
	{
